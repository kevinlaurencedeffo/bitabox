...
urlpatterns = [
    ...
    path("utilisateurs/entreprise/<uuid:entreprise_id>/", UtilisateursParEntrepriseView.as_view(), name="utilisateurs_par_entreprise"),
    ...
    path('entreprises/<uuid:pk>/', EntrepriseRetrieveUpdateDeleteView.as_view(), name='entreprise-detail'),
